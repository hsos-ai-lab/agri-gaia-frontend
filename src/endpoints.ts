...
const EDGE_BENCHMARK_SENSOR_PATH = `${EDGE_BENCHMARK_PATH}/sensor`;
const EDGE_BENCHMARK_START_PATH = `${EDGE_BENCHMARK_PATH}/start`;
const EDGE_BENCHMARK_JOBS_PATH = `${EDGE_BENCHMARK_PATH}/jobs`;
const EDGE_BENCHMARK_RESULTS_PATH = `${EDGE_BENCHMARK_PATH}/results`;
const EDGE_BENCHMARK_FORM_PATH = `${EDGE_BENCHMARK_PATH}/forms`;
