...
const EDGE_BENCHMARK_CATALOG_PATH = `${EDGE_BENCHMARK_PATH}/catalog`;
const EDGE_BENCHMARK_AUTO_SEARCH_PATH = `${EDGE_BENCHMARK_PATH}/auto-search`;
const EDGE_BENCHMARK_AUTO_SEARCH_RESULTS_PATH = `${EDGE_BENCHMARK_AUTO_SEARCH_PATH}/results`;
const EDGE_BENCHMARK_DATASETS_PATH = `${EDGE_BENCHMARK_PATH}/datasets`;
const EDGE_BENCHMARK_FORM_JOB_CREATE_PATH = `${EDGE_BENCHMARK_FORM_PATH}/job-create`;
const EDGE_BENCHMARK_FORM_SENSOR_CONFIG_PATH = `${EDGE_BENCHMARK_FORM_PATH}/sensor-config`;
const EDGE_BENCHMARK_FORM_SENSOR_ADD_PATH = `${EDGE_BENCHMARK_FORM_PATH}/sensor-add`;
...
export {
    ...
    EDGE_BENCHMARK_CATALOG_PATH,
    EDGE_BENCHMARK_AUTO_SEARCH_PATH,
    EDGE_BENCHMARK_AUTO_SEARCH_RESULTS_PATH,
    EDGE_BENCHMARK_DATASETS_PATH,
    EDGE_BENCHMARK_FORM_JOB_CREATE_PATH,
    EDGE_BENCHMARK_FORM_SENSOR_CONFIG_PATH,
    EDGE_BENCHMARK_FORM_SENSOR_ADD_PATH,
};
